...
def encode():
    ...
    newAudio.close()
    audio.close()
    print(" |----> Succesfully encoded text inside Audio_1.wav using Steganography  ")

    print("Applying Triple DES Algorithm to Encrypt  Audio 1 file ")
...
def decode():
    ...
    print("Audio file decryption with DES3 Algorithm Starts :")
